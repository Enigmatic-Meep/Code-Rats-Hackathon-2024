...
class EndScreen(Scene):
    def __init__(self, scene_manager):
        ...
        # Load title image
        self.startScreenImage = pygame.image.load("png/EndScreen.png")

        # Set game to be running
        self.running = True

        # Create buttons using the Button class
        self.start_button = Button("Retry?", (scene_manager.screen_width // 2 - 50, scene_manager.screen_height // 2 + 80), self.white, (100, 100, 100), self.handle_start_click)
